...
# Folder to save recorded videos, active person photo, and known faces
VIDEO_FOLDER = "./videos"
ACTIVE_PERSON_FOLDER = "./active_person"
RECOGNITION_LOG = "./recognized_name.txt"  # Text file for storing the recognized name
...
def record_video(duration):
    ...
    # GStreamer pipeline for recording
    gst_command = [
        "gst-launch-1.0",
        "nvarguscamerasrc",
...
def start_record():
    ...
    recording = True
    duration = int(request.form.get("duration", 5))  # Default to 5 seconds if not provided
...
def capture_active_person():
    ...
    # Ensure the video recording has stopped before taking the photo
    global recording, record_process
